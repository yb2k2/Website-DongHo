<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DongHoCapDoi.aspx.cs" Inherits="DongHoCapDoi" %>
    ...
    <div class="container_custom">
        ...
        <div class="my-3 w-100">
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-1 align-items-center d-flex px-0">
        ...
        <div class="row my-4">
            ...
            <!-- Sản phẩm đồng hồ cặp đôi -->
            <div class="col-md-9">
                <h2 class="text-center title-product animated fadeInDownBig">Đồng hồ cặp đôi</h2>
