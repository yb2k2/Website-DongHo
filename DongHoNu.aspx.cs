...
public partial class DongHoNu : System.Web.UI.Page {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (!IsPostBack) {
            string queryCommand = "select * from SanPham where GioiTinh = N'Nữ' and SoLuongTon > 0";
            SqlDataAdapter sqldaClothesForWomen = new SqlDataAdapter(queryCommand, connect);
            DataSet ds = new DataSet();
            sqldaClothesForWomen.Fill(ds, "ClothesForWomen");
            DataList1.DataSource = ds.Tables["ClothesForWomen"];
            DataList1.DataBind();
        }
    }
