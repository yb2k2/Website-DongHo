<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DongHoTreoTuong.aspx.cs" Inherits="DongHoTreoTuong" %>
    ...
    <div class="container_custom">
        ...
        <div class="my-3 w-100">
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-3 align-items-center d-flex px-0 text-center">
                ...
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-2 align-items-center d-flex px-0">
        ...
        <!-- Danh sách sản phẩm đồng hồ treo tường -->
        <div class="row my-4">
            <div class="col-md-3">
                <!-- Danh mục sản phẩm -->
            ...
            <div class="col-md-9">
                <!-- Tiêu đề cho sản phẩm đồng hồ treo tường -->
                <h2 class="text-center title-product animated fadeInDownBig">Đồng hồ treo tường</h2>

                <!-- Hiển thị danh sách đồng hồ treo tường -->
