<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DongHoNu.aspx.cs" Inherits="DongHoNu" %>
    ...
    <div class="container_custom">
       ...
       <div class="my-3 w-100">
        ...
        <div class="row my-4">
            ...
            <div class="col-md-9">
                <h2 class="text-center title-product animated fadeInDownBig">Đồng hồ nữ</h2>
                    ...
                    <ItemTemplate>
                        <div class="item text-center">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ChiTiet.aspx?masp="+Eval("MaSP") %>'>
                                <asp:Image ID="Image1" runat="server" Width="100%" ImageUrl='<%# "Images/"+Eval("Anh") %>' CssClass="animated rollIn" />
                                <div class="styleText">
