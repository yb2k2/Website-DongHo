<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/LayoutPageAdmin.master" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="Admin_Admin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid">
        <h3 class="title text-center animated zoomInUp">Danh mục sản phẩm</h3>
...
<asp:Image ID="Image1" runat="server" Width="100%" ImageUrl='<%# "Images/"+Eval("Anh") %>' CssClass="animated rotateInUpLeft" />
                        <div class="styleText">
