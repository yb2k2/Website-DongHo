...
public partial class Admin_DongHoCapDoi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            string queryCommand = "select * from SanPham where GioiTinh = 'UN'";
            SqlDataAdapter sqldaClothesForMen = new SqlDataAdapter(queryCommand, connect);
            DataSet ds = new DataSet();
            sqldaClothesForMen.Fill(ds, "CoupleWatches");
