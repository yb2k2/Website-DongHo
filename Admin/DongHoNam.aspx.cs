...
public partial class Admin_DongHoNam : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (!IsPostBack) {
            string queryCommand = "select * from SanPham where GioiTinh = 'Nam'";
            SqlDataAdapter sqldaClothesForMen = new SqlDataAdapter(queryCommand, connect);
            DataSet ds = new DataSet();
            sqldaClothesForMen.Fill(ds, "ClothesForMen");
            DataList1.DataSource = ds.Tables["ClothesForMen"];
            DataList1.DataBind();
        }
    }
