<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/LayoutPageAdmin.master" AutoEventWireup="true" CodeFile="ThemSanPham.aspx.cs" Inherits="Admin_ThemSanPham" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container-fluid">
        <h3 class="title text-center" data-aos="flip-left" data-aos-duration="1500">Thêm sản phẩm</h3>
        <div class="form-group">
            <label>Tên sản phẩm</label>
            <asp:TextBox ID="txtTenSanPham" runat="server" CssClass="form-control w-100 py-2 px-3"></asp:TextBox>
        ...
        <div class="form-group text-center">
            <asp:Button ID="btnThemSanPham" runat="server" Text="Thêm sản phẩm" CssClass="btn btn-danger" OnClick="btnThemSanPham_Click" />
        </div>
    </div>
</asp:Content>
