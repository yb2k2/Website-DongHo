...
public partial class DongHoCapDoi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            string queryCommand = "select * from SanPham where GioiTinh = 'UN' and SoLuongTon > 0";
            SqlDataAdapter sqldaForCoupleWatches = new SqlDataAdapter(queryCommand, connect);
            DataSet ds = new DataSet();
            sqldaForCoupleWatches.Fill(ds, "CoupleWatches");
            DataList1.DataSource = ds.Tables["CoupleWatches"];
            DataList1.DataBind();
        }
    }
    ...
    protected void btnTimKiem_Click(object sender, EventArgs e)
    {
        ...
        string query = "select * from SanPham where TenSP like N'" + txtTimKiem.Text + "%' and GiaBan >= '" + txtMinValue.Text + "' and GiaBan <= '" + txtMaxValue.Text + "' and SoLuongTon > 0 and GioiTinh = N'Nữ'";
